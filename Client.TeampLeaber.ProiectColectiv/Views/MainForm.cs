...
namespace Client.TeampLeaber.ProiectColectiv
{
    public partial class MainForm : Form
    {
        ...
        {
            grpEditareStadiuSolutionare.Visible = visible;
        }

        private void lstCereriAtribuire_SelectedIndexChanged(object sender, EventArgs e)
        {
            grpEditareCerere.Visible = (lstCereriAtribuire.SelectedItem != null && lstCereriAtribuire.SelectedIndex >= 0);
        }

        private void lstStadiiSolutionare_SelectedIndexChanged(object sender, EventArgs e)
        {
            grpEditareStadiuSolutionare.Visible = (lstStadiiSolutionare.SelectedItem != null && lstStadiiSolutionare.SelectedIndex >= 0);
        }
