...
{
    public class StergereStadiuSolutionareRequest : BaseRequest
    {
        private int _id;

        public StergereStadiuSolutionareRequest(int id)
        {
            _id = id;
        }
        ...
        public async Task<bool> Run()
        {
            try
            {
                response = await this.DeleteAsync(Constants.StadiiSolutionarePath + "/" + _id);
