...
{
    public class ModificaMormantReqest : BaseRequest
    {
        private MormantModelForRequest mormant;

        public ModificaMormantReqest(MormantModelForRequest mormant)
        {
        ...
        public async Task<bool> Run()
        {
            try
            {
                response = await this.PostAsJsonAsync(Constants.ModificaMormintePath, mormant);
